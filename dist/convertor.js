(function (global, factory) {
    ...
    var getMapper$1 = memoize(function getMapper$1(to, from) {
        return getMapper(findMapping(to), findMapping(from), allGroups, tightGroups);
    });
