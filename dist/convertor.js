...
(function (PunjabiFontConvertor) {
    PunjabiFontConvertor.anmolMapping = (_a = {},
        ...
        _a[120 /* Nu */] = 0x192,
        _a[125 /* Khanda */] = 0xc7,
        _a[123 /* Divide */] = 0x2039,
        _a[124 /* Multiply */] = 0xbf,
        _a[127 /* FlowerDesign1 */] = 0x152,
        _a[128 /* FlowerDesign2 */] = 0x201a,
        _a[129 /* FlowerDesign3 */] = 0x2030,
        _a[130 /* FlowerDesign4 */] = 0xd3,
        _a[131 /* FlowerDesign5 */] = 0xd4,
        _a[132 /* Diamond */] = 0x2022,
        _a[133 /* KThind */] = 0xff,
        _a[134 /* Colon */] = 0x3a,
        _a[135 /* ColonFancy */] = 0xda,
        _a[136 /* SemiColon */] = 0x3b,
        _a[139 /* Unknown1 */] = 0xb4,
        _a[140 /* TopRightExtention */] = 0xd8,
        _a[141 /* SingleQuoteCurlyLeft */] = 0x2018,
        _a[143 /* SingleQuoteCurlyRight */] = 0x2019,
        _a[145 /* DoubleQuoteCurlyLeft */] = 0x201c,
        _a[146 /* DoubleQuoteCurlyRight */] = 0x201d,
        _a
    );
    var _a;
...
(function (PunjabiFontConvertor) {
    PunjabiFontConvertor.awazeMappings = (_a = {},
        ...
        //[Char.GNine]: 0xf9,
        _a[120 /* Nu */] = 0x2dc,
        _a[121 /* NanaDulainkar */] = 0xb6,
        _a[125 /* Khanda */] = 0x2da,
        _a[126 /* Khanda2 */] = 0x2202,
        //[Char.Divide]: 0x2039,
        _a[124 /* Multiply */] = 0xbf,
        _a[127 /* FlowerDesign1 */] = 0x152,
        ...
        _a[133 /* KThind */] = 0xff,
        _a[134 /* Colon */] = 0x5c,
        _a[136 /* SemiColon */] = 0xdf,
        _a[137 /* SemiColon2 */] = 0xab,
        _a[138 /* SemiColon3 */] = 0x2026,
        _a[139 /* Unknown1 */] = 0xb4,
        _a[140 /* TopRightExtention */] = 0xd8,
        _a[141 /* SingleQuoteCurlyLeft */] = 0x60,
        _a[142 /* SingleQuoteCurlyLeft2 */] = 0xa7,
        _a[143 /* SingleQuoteCurlyRight */] = 0x24,
        _a[144 /* SingleQuoteCurlyRight2 */] = 0xa1,
        _a[145 /* DoubleQuoteCurlyLeft */] = 0x2122,
        _a[146 /* DoubleQuoteCurlyRight */] = 0x23,
        _a[148 /* SquareBracketLeft */] = 0x5b,
        _a[149 /* SquareBracketLeft2 */] = 0x7b,
        _a[150 /* SquareBracketRight */] = 0x5d,
        _a[151 /* SquareBracketRight2 */] = 0x7d,
        _a
    );
    var _a;
})(PunjabiFontConvertor || (PunjabiFontConvertor = {}));
...
(function (PunjabiFontConvertor) {
    PunjabiFontConvertor.asees = (_a = {},
        ...
        _a[120 /* Nu */] = 0x192,
        //[Char.NanaDulainkar] : 0xb6,
        _a[122 /* RaraAunkar */] = 0x57,
        _a[125 /* Khanda */] = 0xc7,
        //[Char.Khanda2]: 0x2202,
        //[Char.Divide]: 0x2039,
        _a[124 /* Multiply */] = 0x25,
        _a[127 /* FlowerDesign1 */] = 0x152,
        _a[128 /* FlowerDesign2 */] = 0x201a,
        _a[129 /* FlowerDesign3 */] = 0x2030,
        _a[130 /* FlowerDesign4 */] = 0xd3,
        ...
        _a[134 /* Colon */] = 0x4c,
        _a[135 /* ColonFancy */] = 0xda,
        _a[136 /* SemiColon */] = 0x6c,
        //[Char.Unknown1]: 0xb4,
        _a[140 /* TopRightExtention */] = 0x46,
        _a[141 /* SingleQuoteCurlyLeft */] = 0x2018,
        _a[143 /* SingleQuoteCurlyRight */] = 0x2019,
        _a[145 /* DoubleQuoteCurlyLeft */] = 0x201c,
        _a[146 /* DoubleQuoteCurlyRight */] = 0x201d,
        _a[147 /* DoubleQuoteCurlyRight2 */] = 0x40,
        _a
    );
    var _a;
})(PunjabiFontConvertor || (PunjabiFontConvertor = {}));
...
(function (PunjabiFontConvertor) {
    ...
    var compositions = moveAcrossChaSet.concat([
        ...
        [[120 /* Nu */], [44 /* Nਨ */, 95 /* Dulainkar */, 77 /* Tippi */], [44 /* Nਨ */, 77 /* Tippi */, 95 /* Dulainkar */], [121 /* NanaDulainkar */, 77 /* Tippi */]],
        [[121 /* NanaDulainkar */], [44 /* Nਨ */, 95 /* Dulainkar */]],
        [[127 /* FlowerDesign1 */], [128 /* FlowerDesign2 */], [129 /* FlowerDesign3 */], [130 /* FlowerDesign4 */], [131 /* FlowerDesign5 */]],
        [[65 /* PairiHahaDulainkar */], [102 /* Virama */, 24 /* Hਹ */, 95 /* Dulainkar */]],
        [[92 /* BihariBindi */], [91 /* Bihari */, 80 /* Bindi */]],
        [[100 /* Kanaura */], [101 /* Kanaura2 */]],
        [[141 /* SingleQuoteCurlyLeft */], [142 /* SingleQuoteCurlyLeft2 */]],
        [[143 /* SingleQuoteCurlyRight */], [144 /* SingleQuoteCurlyRight2 */]],
        [[146 /* DoubleQuoteCurlyRight */], [147 /* DoubleQuoteCurlyRight2 */]],
        [[125 /* Khanda */], [126 /* Khanda2 */]],
        [[134 /* Colon */], [135 /* ColonFancy */]],
        [[136 /* SemiColon */], [137 /* SemiColon2 */], [138 /* SemiColon3 */]],
        [[122 /* RaraAunkar */], [51 /* Rਰ */, 93 /* Aunkar */], [51 /* Rਰ */, 94 /* Aunkar2 */]]
    ]);
